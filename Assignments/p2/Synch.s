...
_CheckVersion_P_Synch_:
	...
	set	0x3888d7fe,r4		! myHashVal = 948492286
	cmp	r3,r4
	be	_Label_9
	set	_CVMess1,r1
	call	_putString
...
!   Call the function
	...
	mov	"\0\0CA",r10
	call	_P_Thread_SetInterruptsTo
!   Retrieve Result: targetName=state  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-24]
! CALL STATEMENT...
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_54:
!   if locked then goto _Label_55 else goto _Label_56
	load	[r14+8],r1
	loadb	[r1+4],r1
	cmp	r1,0
	be	_Label_56
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   lockedThread = _P_Thread_currentThread		(4 bytes)
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	load	[r14+8],r2
	store	r1,[r2+8]
...
!   Send message IsEmpty
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_67  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-9]
!   if _temp_67 then goto _Label_66 else goto _Label_65
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_65
	jmp	_Label_66
...
!   if intIsZero (nextThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_70 = nextThread + 76
	load	[r14+-36],r1
	add	r1,76,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_70 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   if lockedThread != _P_Thread_currentThread then goto _Label_83		(int)
	load	[r14+8],r1
	load	[r1+8],r1
...
!   _temp_81 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_84:
!   ReturnResult: _temp_81  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,8,r15
	pop	r13
