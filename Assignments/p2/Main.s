...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0x3888d7fe (decimal 948492286)
	set	_packageName,r2
	set	0x3888d7fe,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_myLock1
	set	_Global_myLock1,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_fullBufferSem
	set	_Global_fullBufferSem,r1
	store	r1,[r14+-212]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_emptyBufferSem
	set	_Global_emptyBufferSem,r1
	store	r1,[r14+-208]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_426 = &_Global_emptyBufferSem
	set	_Global_emptyBufferSem,r1
	store	r1,[r14+-40]
!   Send message Down
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_432 = &_Global_fullBufferSem
	set	_Global_fullBufferSem,r1
	store	r1,[r14+-16]
!   Send message Up
	load	[r14+-16],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_451 = &_Global_fullBufferSem
	set	_Global_fullBufferSem,r1
	store	r1,[r14+-40]
!   Send message Down
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_457 = &_Global_emptyBufferSem
	set	_Global_emptyBufferSem,r1
	store	r1,[r14+-16]
!   Send message Up
	load	[r14+-16],r1
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: _Global_mon = zeros  (sizeInBytes=124)
	set	_Global_mon,r4
	mov	31,r3
_Label_794:
	store	r0,[r4]
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_596 = *_temp_600  (sizeInBytes=24)
	load	[r14+-148],r5
	load	[r14+-184],r4
	load	[r5],r1
	store	r1,[r4]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: mylock2 = zeros  (sizeInBytes=12)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
!   mylock2 = _P_Synch_Mutex
...
!   Next value...
!   NEW CLASS Constructor...
!   ZeroMemory: _temp_607 = zeros  (sizeInBytes=16)
	add	r14,-40,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
	store	r0,[r4+12]
!   _temp_607 = _P_Synch_Condition
	set	_P_Synch_Condition,r1
	store	r1,[r14+-40]
	mov	5,r1
	store	r1,[r14+-44]
_Label_609:
!   Data Move: *_temp_605 = _temp_607  (sizeInBytes=16)
	add	r14,-40,r5
	load	[r14+-48],r4
	load	[r5],r1
	store	r1,[r4]
...
!   _temp_606 = _temp_606 + -1
	...
	add	r1,-1,r1
	store	r1,[r14+-44]
!   if intNotZero (_temp_606) then goto _Label_609
	load	[r14+-44],r1
	cmp	r1,r0
	bne	_Label_609
!   Initialize the array size...
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_603 = *_temp_610  (sizeInBytes=84)
	load	[r14+-20],r5
	load	[r14+-136],r4
	mov	21,r3
_Label_799:
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_611:
!   if i >= 5 then goto _Label_613		(int)
	load	[r14+-188],r1
	mov	5,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-136]
!   Data Move: *_temp_637 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-136],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_645 = _temp_646 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-120]
!   Move address of _temp_644 [_temp_645 ] into _temp_647
!     make sure index expr is >= 0
	load	[r14+-120],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-112]
!   Data Move: _temp_643 = *_temp_647  (sizeInBytes=4)
	load	[r14+-112],r1
	load	[r1],r1
	store	r1,[r14+-128]
!   if _temp_643 != 2 then goto _Label_642		(int)
	load	[r14+-128],r1
	mov	2,r2
	cmp	r1,r2
	bne	_Label_642
...
!   Data Move: _temp_648 = *_temp_652  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-108]
!   if _temp_648 != 2 then goto _Label_641		(int)
	load	[r14+-108],r1
	mov	2,r2
	cmp	r1,r2
	bne	_Label_641
...
!   Data Move: _temp_660 = *_temp_662  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-76]
!   if _temp_660 != 1 then goto _Label_657		(int)
	load	[r14+-76],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_657
...
!   _temp_665 = _temp_666 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-56]
!   Move address of _temp_664 [_temp_665 ] into _temp_667
!     make sure index expr is >= 0
	load	[r14+-56],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_663 = *_temp_667  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-64]
!   if _temp_663 == 2 then goto _Label_657		(int)
	load	[r14+-64],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_657
...
!   Data Move: _temp_668 = *_temp_672  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-44]
!   if _temp_668 == 2 then goto _Label_657		(int)
	load	[r14+-44],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_657
...
!   _temp_715 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-64]
!   Move address of _temp_715 [p ] into _temp_716
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-60]
!   Data Move: *_temp_716 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-60],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_720 = _temp_721 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-44]
!   Move address of _temp_719 [_temp_720 ] into _temp_722
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_725 = _temp_726 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   Move address of _temp_724 [_temp_725 ] into _temp_727
!     make sure index expr is >= 0
	load	[r14+-24],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_752 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_751  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_747:
!   Perform the FOR-LOOP termination test
!   if p > _temp_752 then goto _Label_750		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_759 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_759 [p ] into _temp_760
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
